  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-soft": {
          "0%, 100%": { transform: "scale(1)", boxShadow: "0 10px 30px -10px hsl(var(--brand-accent) / 0.45)" },
          "50%": { transform: "scale(1.04)", boxShadow: "0 14px 36px -10px hsl(var(--brand-accent) / 0.65)" },
        },
        "scale-in": {
